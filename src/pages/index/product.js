...
import PhanTrang from '../index/pagination.js'
    ...
    return (
        <div className='row pt-5'>
            <div className='col-md-4 pt-3 pb-3'>
                <Form.Select className="form-select border-0 select-option-content" disabled>
            ...
            <div className='col-md-4 pt-3 pb-3'>
                <div className="card product-content border-0">
                    <div className="card-body col-md-10 mx-auto">
